...
static const char qt_meta_stringdata_JoystickGripperInterface[] = {
    "JoystickGripperInterface\0\0"
    "joystickGripperWristControlTimerEventHandler()\0"
    "joystickGripperFingerControlTimerEventHandler()\0"
};
...
void JoystickGripperInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->joystickGripperWristControlTimerEventHandler(); break;
        case 1: _t->joystickGripperFingerControlTimerEventHandler(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData JoystickGripperInterface::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject JoystickGripperInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_JoystickGripperInterface,
      qt_meta_data_JoystickGripperInterface, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &JoystickGripperInterface::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoystickGripperInterface))
